...
\begin{frame}{End-to-end learning}
    ...
    \begin{figure}[!h] 
        ...
        % \caption[Esquema de un sistema de reconocimiento de voz.]{Esquema de un sistema de reconocimiento de voz.. Fuente: \cite{cornelisse_2018} }
    \end{figure}
\end{frame}
...
\begin{frame}{Módulo de potencia en tiempo real}
    ...
    \begin{columns}
        ...
        \end{column}
    \end{columns}
    \footnotetext{Requerimientos de temporización estrictos. Tiempo de muestreo para el motor: 500 us}
\end{frame}
...
\begin{frame}{Módulo de la computadora de abordo (OBC)}
    \begin{figure}[!h] 
        \centering
        \includegraphics[width=0.75\textwidth]{../img/carro}
